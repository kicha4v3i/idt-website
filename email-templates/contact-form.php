...
if( ! empty( $_POST['email'] ) ) {
	...
	$receiver_email = 'krishna@i-bytes.com';

	// Email Receiver Name for SMTP Email
	$receiver_name 	= 'iDrilling Technologies';

	// Email Subject
	$subject = 'Contact form details';

	// Google reCaptcha secret Key
	$grecaptcha_secret_key = '6LeSJlorAAAAAENiD-YtepYIr305cF_Nh_m1B6yJ';
	...
	if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
		...
		if( $enable_smtp == 'no' ) { // Simple Email
			...
			$mail->SMTPAuth = true;
			$mail->Username = 'AKIAVGQ5EOALKCWWMVPO'; // Your Username
			$mail->Password = 'BH3KCMLcuL6i1FHCxmY6PJEFfiuZV6Nzj3P+yocSPHgt'; // Your Password
